...
/**
 * Exends Customer Data Helper
 */
class Gufo_RedirectAfterCustomerCreation_Helper_Data extends Mage_Customer_Helper_Data
{
    ...
    {
        return $this->_getUrl('customer/account/create', $this->getLoginUrlParams());
    }
